...
from .Grandetester import GRANDETester


class GRANDETestRunner(BaseTestRunner):
    """Test runner dla GRANDE używający wspólnych komponentów."""
    ...
    def get_tester_instance(self, num_classes: int) -> GRANDETester:
        return GRANDETester(num_classes=num_classes)