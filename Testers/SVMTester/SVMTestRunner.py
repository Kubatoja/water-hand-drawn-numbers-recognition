...
class SVMTestRunner:
    ...
    def __init__(
        ...
        self.result_collector = TestResultCollector(algorithm_name="SVM")
    ...
    def run_tests(self, test_configs: List[SVMTestConfig]) -> List[TestResult]:
    ...
    def _run_single_test(self, test_config: SVMTestConfig, test_index: int) -> TestResult:
        ...
        tester = SVMTester(num_classes=test_config.class_count)
