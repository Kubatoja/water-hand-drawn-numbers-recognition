...
from Testers.HyperFastTester.HyperFastTester import HyperFastTester


class HyperFastTestRunner(BaseTestRunner):
    """Test runner dla HyperFast używający wspólnych komponentów"""
    ...
    def get_tester_instance(self, num_classes: int):
        return HyperFastTester(num_classes=num_classes)
