...
from Testers.MLPTester.MLPTester import MLPTester


class MLPTestRunner:
    """Test runner dla MLP używający wspólnych komponentów"""
    ...
    def __init__(
        ...
        self.result_collector = TestResultCollector(algorithm_name="MLP")
    ...
    def run_tests(self, test_configs: List[MLPTestConfig]) -> List[TestResult]:
        """Uruchamia wszystkie testy używający wspólnego VectorManager"""
    ...
    def _run_single_test(self, test_config: MLPTestConfig, test_index: int) -> TestResult:
        ...
        print("Training and testing MLP model...")
        tester = MLPTester(num_classes=test_config.class_count)
