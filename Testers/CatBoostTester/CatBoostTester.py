...
class CatBoostTester:
    """Klasa odpowiedzialna za testowanie modeli CatBoost"""
    ...
    def _perform_cross_validation(
        ...
        for fold_idx, (train_idx, val_idx) in enumerate(skf.split(X_train, y_train)):
            ...
            fold_model = CatBoostClassifier(
                ...
                # USUNIĘTO: class_names=list(range(self.num_classes))
            )
    ...
    def train_and_test(
        ...
        cv_n_folds: int = 5
    ) -> tuple[CatBoostClassifier, TestResult, list[TestResult]]:
        ...
        print("Training CatBoost model on full training set...")
