...
from Testers.CatBoostTester.CatBoostTester import CatBoostTester


class CatBoostTestRunner(BaseTestRunner):
    """Test runner dla CatBoost używający wspólnych komponentów"""
    ...
    def get_tester_instance(self, num_classes: int):
        return CatBoostTester(num_classes=num_classes)
