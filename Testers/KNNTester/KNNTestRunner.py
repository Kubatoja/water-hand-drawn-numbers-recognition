...
from Testers.KNNTester.KNNTester import KNNTester


class KNNTestRunner(BaseTestRunner):
    """Test runner dla KNN używający wspólnych komponentów"""
    ...
    def get_tester_instance(self, num_classes: int):
        return KNNTester(num_classes=num_classes)