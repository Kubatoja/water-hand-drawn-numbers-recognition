...
if __name__ == "__main__":
    ...
    train_dataset = 'Data/emnist-digits-train.csv'
    ...
    test_dataset = 'Data/emnist-digits-test.csv'
    ...
    default_confg = ANNTestConfig(
        trees_count=2,
        leaves_count=328,
        training_set_limit=1298,  # Full test ultra-optimizations
        num_segments=7,
        ...
        enable_centering=True  # Włączamy centrowanie cyfr
    )
    ...
    configs_to_generate = [
        ...
        FieldConfig(ANNTestConfigField.PIXEL_NORMALIZATION_RATE, start=0.28, stop=0.28, step=0.01),
